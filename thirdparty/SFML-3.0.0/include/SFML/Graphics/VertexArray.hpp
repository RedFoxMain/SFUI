...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// Return the a read-write access to a vertex by its index
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// Return the a read-only access to a vertex by its index
    ///
    /// This function doesn't check `index`, it must be in range
    /// [0, `getVertexCount()` - 1]. The behavior is undefined
    /// otherwise.
    ...
    ////////////////////////////////////////////////////////////
    /// Return the the type of primitives drawn by the vertex array
    ///
