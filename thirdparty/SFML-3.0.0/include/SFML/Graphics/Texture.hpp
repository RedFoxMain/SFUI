...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// Return the the underlying OpenGL handle of the texture.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// Return the the maximum texture size allowed
    ///
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// Return the a valid image size according to hardware support
    ///
...
///
/// `Texture` makes it easy to convert from/to `sf::Image`, but
...
/// of booleans.
///
/// Like `sf::Image`, `Texture` can handle a unique internal
...
/// `Texture` can also be used directly as a raw texture for
